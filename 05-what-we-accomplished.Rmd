...
df_weekly_weight %>%
  ...
  theme(legend.title = element_blank(), legend.position = "none",
        text = element_text(size=CHART_ELEMENT_TEXT_SIZE-15)) +
...
df_forecast_p2 %>%
  ...
  annotate(geom = "text", x = df_target_achieved_p2$date-4, y = df_target_achieved_p2$target+7, label = glue("(Dt: {df_target_achieved_p2$date}, Wt: {df_target_achieved_p2$target} lb)"), size=7, hjust = "left") +
  scale_color_tableau() + 
  scale_fill_tableau() + 
  theme_fivethirtyeight() +
