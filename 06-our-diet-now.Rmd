...
At a personal level, there is something else that automatically makes me say no to alcohol, it is a very simple test that I use when I need to: "Is this drink going to improve my deadlift performance?" the answer, obviously, is "No" and therefore that is also my answer to the drink, "No". Juxtaposing two choices together clearly brings out the answer that we knew all along to be correct but was difficult to tell ourselves.
...
4. Dinner is now higher carbs (please do not delay dinner beyond 7:30pm) which helps with a good night sleep and fueling the workouts the next morning.
