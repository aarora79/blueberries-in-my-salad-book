...
Viewing this journey from a completely different lens and using the deadlift as a metaphor, I guess we should all try to find something that takes perseverance and hard work over a long period of time to achieve and then get on with the journey to achieve that. Over a period of time we will realize that the goal was just the first dopamine trigger but then as we keep putting in the hard yards and keep seeing the milestones along the way, we keep getting those dopamine hits, and that helps to keep us going. We live in a world today that is designed to provide instant gratification, so this idea that it will take years of consistent effort to achieve something, especially something that is not directly financially rewarding, takes some time to settle.
