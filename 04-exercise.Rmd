...
The following tables show the different exercises we did, over time, as part of the warmups, strength, conditioning and core. These were done over a period of time, with the more difficult ones such as the Turkish getup added much later and for the ones which we did from the start we kept on increasing the weights or the numbers of sets and reps over time. This is a rather long list, we kept meticulous notes of what exercise we did and weights we used for those exercises (wherever applicable). The purpose of putting the entire list here is to emphasize two things, firstly a good training routine requires a lot of exercise to train the big muscles, the small muscles and everything in between and secondly this is not DIY, there is a lot of thinking and planning that goes on behind the scenes that is done by a good PT (personal trainer). At the same time, I do not want anyone who works out at home on a treadmill, a spin bike, goes out for a run, or does any other form of exercise to see the following table and feel overwhelmed. We just organically fell into this routine, our lives took a turn, we found this beautiful path through the woods and we just decided to explore it further and have loved every step of the trail.
